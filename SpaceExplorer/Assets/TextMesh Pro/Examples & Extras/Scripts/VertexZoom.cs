        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
					...
					// Restore Source UVS which have been modified by the sorting (uvs0 hiện là Vector4[])
                ...
                for (int i = 0; i < textInfo.meshInfo.Length; i++)
                {
					...
					// uvs0 là Vector4[] nên dùng SetUVs(0, List<Vector4>) thay vì mesh.uv
					{
						var uvs0 = textInfo.meshInfo[i].uvs0;
						var uvsList = new List<Vector4>(uvs0);
						textInfo.meshInfo[i].mesh.SetUVs(0, uvsList);
					}
